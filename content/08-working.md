...
The first thing to mention is that finding some form of internet is rarely an issue. Really. Even in some of the most remote countries you won’t struggle to find a 3G sim card, USB dongle, or local internet cafe. The hard part, always, is finding speed and reliability. If the only things I had to do online were email and web browsing - I would rarely have any problems. The issues kick in when you need to download a large file, update your software, backup your work to Dropbox, work with a server over an FTP connection, or anything else that requires more than 1MB of bandwidth. For this, I have a few tips on where to find wifi based on experience:

### Mifi

In the last few years, one technology which has taken off in dramatic style is that of the 3G Data Sim. With the abundance of tablets and netbooks nowadays which require a pure data connection, almost every mobile network in the works has a 3G Data Sim plan. By and large, these are the absolute best ways to get online when travelling. Paired with a small Huwaei Mifi (Mobile Wifi) device, you can carry a portable hotspot with you wherever you go, whenever you go. Just pick up a sim when you arrive in a new country. Most places have a plan for "30 days unlimited" internet for between $20-$50 - and speeds can go as high as 20mbps.

### Public Libraries

Found pretty much everywhere, “libraries” are large buildings where (apparently) people can "borrow printed books". Of course now we have the internet - which is like a very, very big library. Traditional libraries seem to have caught onto this, so these days public libraries are pretty much just big internet cafes with remarkably few customers. Where they really win is that they’re generally government subsidised, and can afford a good internet connection as a result. If you want a particularly quiet place to work, these are often a good place to start.
